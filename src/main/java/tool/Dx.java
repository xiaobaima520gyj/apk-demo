...
public class Dx {
    ...
    public static void dxCommand(File aarDex, File classes_jar) throws IOException, InterruptedException {
        ...
        System.out.println("aarDex path:" + aarDex.getAbsolutePath());
        System.out.println("class_jar path:" + classes_jar.getAbsolutePath());
        Process process = runtime.exec("/Users/mac/Library/Android/sdk/build-tools/29.0.2/dx --dex --output=" + aarDex.getAbsolutePath() + " " +
